...
@app.route('/indexpage')
def indexpage():\
    return render_template('index_CH.html', img_tag="")
...
def make_chart():
    ...
    plt.xticks(rotation=-90) # with 45 this gets cluttered with yearly data
    plt.tight_layout()
    ...
    return render_template('index_CH.html', img_tag=img_tag)
